...
export const navigationTabs: NavTab[] = [
  ...
  },
  {
    ...
    allowedRoles: ['admin'],
    items: [
      { id: "gusto", icon: Building2, label: "HR & Payroll", href: "/gusto", adminOnly: true, allowedRoles: ['admin'] },
      { id: "announcements", icon: Megaphone, label: "Announcements", href: "/changelog-admin", adminOnly: true, allowedRoles: ['admin'] },
      { id: "feedback", icon: MessageSquare, label: "Feedback", href: "/feedback", adminOnly: true, allowedRoles: ['admin'] },
      { id: "system-health", icon: BarChart3, label: "System Health", href: "/system-health", adminOnly: true, allowedRoles: ['admin'] },
      { id: "admin", icon: Shield, label: "Admin", href: "/admin", adminOnly: true, allowedRoles: ['admin'] },
    ],
  },
];
